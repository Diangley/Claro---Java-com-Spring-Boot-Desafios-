...
public class Main {
    ...
    public static int identificarSemanaDeMaiorConsumo(String[] consumoSemanal) {
        int semanaDeMaiorConsumo = 1;  // Começa com a semana 1
        int maiorConsumo = Integer.parseInt(consumoSemanal[0].trim());  // Inicia com o consumo da primeira semana
        ...
        for (int i = 1; i < consumoSemanal.length; i++) {
            ...
            if (consumo > maiorConsumo) {
                ...
                semanaDeMaiorConsumo = i + 1;  // Ajuste para basear-se na semana atual
            }
        }
